        ...
        const fetchShop = async () => {
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    setShop({
                        title: data.name || (paramTitle as string) || 'Shop',
                        distance: data.location ? "Approx. distance" : "Distance not available", // Shops often lack 'distance' field in sample, using fallback
                        rating: data.rating || 4.5,
                        location: data.location || "Unknown location",
                        time: data.time || "10 AM - 9 PM", // Fallback time
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.headerContainer}>
                    {shop.images && shop.images.length > 0 ? (
                        <Image source={{ uri: shop.images[0] }} style={styles.headerImage} resizeMode="cover" />
                    ) : (
                    ...
                    <View style={styles.headerInfo}>
                        ...
                        <Text style={styles.distance}>{shop.distance === "Approx. distance" ? shop.location : shop.distance}</Text>
                    </View>
                </View>
